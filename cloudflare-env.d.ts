/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: ad3e2b9890558246d5419edf5deef886)
// Runtime types generated with workerd@1.20260918.1 2026-09-20 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	UPLOADS: R2Bucket;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXT_PUBLIC_SUPABASE_URL: "https://guuetpqdvepezffsjtjo.supabase.co";
	NEXT_PUBLIC_SUPABASE_ANON_KEY: "sb_publishable_csG7wFOerGGDFqyQn7jdyQ_a7WYqBpB";
	DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_ANON_KEY" | "DATABASE_URL">> {}
}
