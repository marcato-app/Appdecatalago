    ...
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-5 px-6 py-10">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
          ...
          <span className="font-mono text-xs">iPhone 15 Pro Max / Titânio Natural / foto1.jpg</span>) — compacte essa
          pasta num .zip e envie aqui. O Flip casa cada pasta com o aparelho e a cor certos na sua loja, sem precisar
          abrir um por um. O nome da pasta precisa bater com o nome do modelo já cadastrado (importe pelo Catálogo
          antes, se ainda não fez).
        </p>
      </div>
