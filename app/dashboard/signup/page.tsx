    ...
    <div className="flex flex-1 flex-col items-center justify-center bg-zinc-50 px-6 py-16 dark:bg-zinc-950">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
          ...
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Cadastre-se para criar o catálogo da sua loja.</p>
        ...
        <p className="mt-6 text-center text-sm text-zinc-500 dark:text-zinc-400">
          Já tem conta?{" "}
          <Link href="/dashboard/login" className="font-semibold text-violet-600 hover:text-violet-700 dark:text-violet-400">
            Entrar
          </Link>
        </p>
      </div>
