...
import { manifest as iphoneStore } from "./iphone-store/manifest";

// Central lookup for every template manifest. Adding a template means:
...
export const templateManifests: TemplateManifest[] = [adegaMm, barbeariaTnt, clinica, iphoneStore];
